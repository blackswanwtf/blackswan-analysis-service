 ...
 * Handles loading, versioning, and templating of Black Swan analysis prompts
 */
...
class PromptManager {
   ...
   * @param {string} promptName - Name of the prompt (e.g., 'blackswan-analysis')
   * @param {string} version - Version (e.g., 'v1', 'v2')
   * @returns {string} Raw prompt template
   */
  loadPromptTemplate(promptName = "blackswan-analysis", version = null) {
   ...
   */
  getAvailableVersions(promptName = "blackswan-analysis") {
    try {
